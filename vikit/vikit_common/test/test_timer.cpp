...
int main(int argc, char **argv) {
    ...
    std::cout << "total sleep took " << t.getAccumulated() << " seconds"
              << std::endl;

    std::cout << "seconds since 1.1.1970 is " << std::setprecision(15)
              << vk::Timer::getCurrentTime() << std::endl;

    std::cout << "current date is " << vk::Timer::getCurrentTimeStr()
              << std::endl;
    return 0;
}
