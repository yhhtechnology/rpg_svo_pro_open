...
int main(int argc, char **argv) {
    ...
    vk::AbstractCamera::Ptr cam_pinhole(new vk::PinholeCamera(
    ...
    vk::AbstractCamera::Ptr cam_atan(new vk::ATANCamera(
        752, 480, 0.511496, 0.802603, 0.530199, 0.496011, 0.934092));

    vk::AbstractCamera::Ptr cam_equidistant(new vk::PinholeEquidistantCamera(
        752, 480, 463.34128261574796, 461.90887721986877, 361.5557340721321,
        231.13558880965206, -0.0027973061697674074, 0.024145501123661265,
        -0.04304211254137983, 0.031185314072573474));
