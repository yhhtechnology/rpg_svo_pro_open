...
void PinholeProjection<Distortion>::project3(
    ...
    if (out_jacobian_point) {
        ...
        (*out_jacobian_point) =
            focal_matrix * distortion_.jacobian(uv) * duv_dxy;
    }
}
...
PinholeProjection<Distortion>::createTestProjection(const size_t image_width,
                                                    const size_t image_height) {
    return PinholeProjection(image_width / 2, image_width / 2, image_width / 2,
                             image_height / 2,
