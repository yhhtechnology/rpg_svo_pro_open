...
class NoDistortion {
 public:
    ...
    inline void distort(double& /*u*/, double& /*v*/) const {}
    ...
    inline void undistort(double& /*u*/, double& /*v*/) const {}
    ...
    static inline NoDistortion createTestDistortion() { return NoDistortion(); }
};
