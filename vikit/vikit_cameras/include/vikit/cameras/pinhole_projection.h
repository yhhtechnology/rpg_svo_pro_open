...
class PinholeProjection {
 public:
    ...
    const CameraGeometryBase::Type cam_type_ =
        CameraGeometryBase::Type::kPinhole;
    ...
    PinholeProjection(const Eigen::VectorXd& intrinsics,
    ...
    bool backProject3(const Eigen::Ref<const Eigen::Vector2d>& keypoint,
                      Eigen::Vector3d* out_point_3d) const;

    // Computes pixel coordinates from bearing vector.
    void project3(const Eigen::Ref<const Eigen::Vector3d>& point_3d,
