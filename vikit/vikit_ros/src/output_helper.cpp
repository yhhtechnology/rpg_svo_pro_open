...
void publishTfTransform(const Transformation& T,
    ...
    transform_msg.setOrigin(tf::Vector3(
    ...
    br.sendTransform(
        tf::StampedTransform(transform_msg, stamp, frame_id, child_frame_id));
}
...
void publishFrameMarker(ros::Publisher pub,
    ...
    point.x = static_cast<float>(
        pos.x() + marker_scale * rot(0, 2));  // Draw arrow in z-direction
    point.y = static_cast<float>(
        pos.y() + marker_scale * rot(1, 2));  // Draw arrow in z-direction
    point.z = static_cast<float>(
        pos.z() + marker_scale * rot(2, 2));  // Draw arrow in z-direction
    marker.points.push_back(point);
    marker.scale.x = 0.2 * marker_scale;
    marker.scale.y = 0.2 * marker_scale;
    marker.color.a = 1.0;
    ...
    marker.points.push_back(point);
    point.x = static_cast<float>(
        pos.x() + marker_scale * rot(0, 0));  // Draw arrow in x-direction
    point.y = static_cast<float>(
        pos.y() + marker_scale * rot(1, 0));  // Draw arrow in x-direction
    point.z = static_cast<float>(
        pos.z() + marker_scale * rot(2, 0));  // Draw arrow in x-direction
    marker.points.push_back(point);
    marker.color.r = 1.0;
    marker.color.g = 0.0;
    marker.color.b = 0.0;
    ...
    marker.points.push_back(point);
    point.x = static_cast<float>(
        pos.x() + marker_scale * rot(0, 1));  // Draw arrow in y-direction
    point.y = static_cast<float>(
        pos.y() + marker_scale * rot(1, 1));  // Draw arrow in y-direction
    point.z = static_cast<float>(
        pos.z() + marker_scale * rot(2, 1));  // Draw arrow in y-direction
    marker.points.push_back(point);
    marker.color.r = 0.0;
    marker.color.g = 1.0;
    marker.color.b = 0.0;
...
void publishGtsamPoseCovariance(
    ...
    VLOG(20) << "Eigenvalues are " << lambda_1 << ", " << lambda_2 << ", " <<
    lambda_3;
    ...
    */
    ...
    Eigen::JacobiSVD<Matrix3d> svd(pose_covariance,
