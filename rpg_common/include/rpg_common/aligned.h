...
template <template <typename Type, typename Allocator> class StlContainer,
          typename EigenType>
using Aligned = StlContainer<EigenType, Eigen::aligned_allocator<EigenType>>;
...
using UnorderedMapEigenKey = std::unordered_map<
    EigenType,
    ValueType,
    std::hash<EigenType>,
...
using UnorderedSet = std::unordered_set<EigenType,
                                        std::hash<EigenType>,
                                        std::equal_to<EigenType>,
