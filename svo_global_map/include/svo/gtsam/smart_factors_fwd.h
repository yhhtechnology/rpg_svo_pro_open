...
using CamPointDistFactor =
    gtsam::RangeFactorWithTransform<gtsam::Pose3, gtsam::Point3, double>;
using CameraBearingFactor3D =
    gtsam::CameraBearingFactor<gtsam::Pose3, gtsam::Point3>;
using CameraBearingTbcFactor =
    gtsam::CameraBearingExtrinsicsFactor<gtsam::Pose3, gtsam::Point3>;
