...
class GraphManager {
 public:
    ...
    using PreintegratedImuMeasurements =
    ...
    /// Updates to be considered for next optimization iteration. MUTEX
    /// PROTECTED
    /// @{
    ...
    void addExtrinsics(const svo::Transformation& T_b_c, const size_t cam_id);
    ...
    void addCombinedImuFactor(const NFramesId& from_id,
    ...
    void registerNewFactor(const int id,
