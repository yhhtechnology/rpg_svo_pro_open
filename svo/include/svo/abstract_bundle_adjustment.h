...
class AbstractBundleAdjustment {
 public:
    ...
    AbstractBundleAdjustment& operator=(const AbstractBundleAdjustment&) =
        delete;
     ...
     */
    virtual void getLatestSpeedBiasPose(Eigen::Matrix<double, 9, 1>* speed_bias,
                                        Transformation* T_WS,
                                        double* timestamp) const = 0;

    BundleAdjustmentType getType() const { return type_; }
