...
class Map {
 public:
    ...
    /// Moves the point to the trash bin, cleared after all reprojectors have
    /// done their job
    ...
    /// We use a hashtable to store the keyframes. This function provides a
    /// sorted
    /// list of keyframes.
    ...
    inline FramePtr getLastKeyframe() {
        return this->getKeyframeById(last_added_kf_id_);
    }
