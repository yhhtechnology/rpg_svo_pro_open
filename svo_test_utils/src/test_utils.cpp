...
#ifdef SVO_USE_ROS
    std::string default_dir(ros::package::getPath("svo_experiments") +
                            "/results");
...
FrameBundle::Ptr createFrameBundle(CameraPtr cam,
...
void calcHist(const std::vector<double>& values,
              size_t bins,
...
cv::Mat drawHist(const std::vector<size_t>& hist,
