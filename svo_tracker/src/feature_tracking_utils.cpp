...
double getTracksDisparityPercentile(const FeatureTracks& tracks,
                                    double pivot_ratio) {
    ...
    std::nth_element(disparities.begin(), disparities.begin() + pivot,
                     disparities.end(), std::greater<double>());
