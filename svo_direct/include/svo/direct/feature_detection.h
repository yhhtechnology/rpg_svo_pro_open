...
class AbstractDetector {
 public:
    ...
    /// Default constructor.
    AbstractDetector(const DetectorOptions& options, const CameraPtr& cam);
    ...
    virtual void detect(const ImgPyr& img_pyr,
                        const cv::Mat& mask,
    ...
    // this is to additionally check whether detected features are near some
    // exiting ones
...
//------------------------------------------------------------------------------
/// Detect pixels that have a high gradient magnitude over multiple pyramid
/// levels.
...
//------------------------------------------------------------------------------
/// shitomasi detector: This should be called after other detectors. The
/// intention
/// of this detector is to get some extra features for loop closing. It detects
/// shitomasi
/// features and keeps the ones which are a minimum distance away from existing
/// corners.
...
/// Huang, J. and Mumford, D. (1999). Statistics of natural images and models.
/// (CVPR)
