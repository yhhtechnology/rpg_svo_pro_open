    ...
    ZMSSD(uint8_t* ref_patch) : ref_patch_(ref_patch) {
        ...
        if (patch_size_ == 0) {
            ...
            for (int i = 0; i < 64; i += 8) {
                ...
                sumAAx4 = vmlal_u16(sumAAx4, vget_low_u16(tpl_x8),
                                    vget_low_u16(tpl_x8));
                sumAAx4 = vmlal_u16(sumAAx4, vget_high_u16(tpl_x8),
                                    vget_high_u16(tpl_x8));
            }
            uint16x4_t sumAx4 =
                vpadd_u16(vget_low_u16(sumAx8), vget_high_u16(sumAx8));
            sumA_ = vget_lane_u16(sumAx4, 0) + vget_lane_u16(sumAx4, 1) +
                    vget_lane_u16(sumAx4, 2) + vget_lane_u16(sumAx4, 3);

            uint32x2_t sumAAx2 =
                vpadd_u32(vget_low_u32(sumAAx4), vget_high_u32(sumAAx4));
    ...
    int computeScore(uint8_t* cur_patch, int stride) const {
        ...
        if (patch_size_ == 8) {
            ...
            for (int i = 0; i < 64; i += 8, cur_ptr += stride, ref_ptr += 8) {
                ...
                // multiply and sum
                sumBBx4 = vmlal_u16(sumBBx4, vget_low_u16(img_x8),
                                    vget_low_u16(img_x8));
                sumBBx4 = vmlal_u16(sumBBx4, vget_high_u16(img_x8),
                                    vget_high_u16(img_x8));
                // multiply and sum
                sumABx4 = vmlal_u16(sumABx4, vget_low_u16(tpl_x8),
                                    vget_low_u16(img_x8));
                sumABx4 = vmlal_u16(sumABx4, vget_high_u16(tpl_x8),
                                    vget_high_u16(img_x8));
            }
            uint16x4_t sumBx4 =
                vpadd_u16(vget_low_u16(sumBx8), vget_high_u16(sumBx8));
            sumB = vget_lane_u16(sumBx4, 0) + vget_lane_u16(sumBx4, 1) +
                   vget_lane_u16(sumBx4, 2) + vget_lane_u16(sumBx4, 3);

            uint32x2_t sumBBx2 =
                vpadd_u32(vget_low_u32(sumBBx4), vget_high_u32(sumBBx4));
            sumBB = vget_lane_u32(sumBBx2, 0) + vget_lane_u32(sumBBx2, 1);

            uint32x2_t sumABx2 =
                vpadd_u32(vget_low_u32(sumABx4), vget_high_u32(sumABx4));
