...
/// Factory returns a pointer to a detector that is specified with in the
/// options.
AbstractDetectorPtr makeDetector(const DetectorOptions& options,
                                 const CameraPtr& cam);
...
void detectGuillermoEdges(const cv::Mat& src_gray,
                          cv::Mat& dest,
