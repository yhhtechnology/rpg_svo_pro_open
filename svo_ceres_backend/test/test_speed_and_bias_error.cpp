...
TEST(okvisTestSuite, SpeedAndBiasError) {
    ...
    for (size_t i = 0; i < n_terms; ++i) {
        ...
        std::shared_ptr<svo::ceres_backend::SpeedAndBiasParameterBlock>
            speedandbias_parameter_block = std::make_shared<
                svo::ceres_backend::SpeedAndBiasParameterBlock>(speed_and_bias,
                                                                i);
        ...
        // invent an error
        std::shared_ptr<svo::ceres_backend::SpeedAndBiasError>
            speedandbias_error =
