...
inline bool isSeed(const FeatureType& t) { return static_cast<uint8_t>(t) < 6; }
...
inline bool isCornerEdgeletSeed(const FeatureType& t) {
    return (t == FeatureType::kEdgeletSeedConverged ||
            ...
            t == FeatureType::kEdgeletSeed || t == FeatureType::kCornerSeed);
}
...
inline bool isUnconvergedCornerEdgeletSeed(const FeatureType& t) {
    return (t == FeatureType::kEdgeletSeed || t == FeatureType::kCornerSeed);
}
...
inline bool isEdgelet(const FeatureType& t) {
    return (t == FeatureType::kEdgelet || t == FeatureType::kEdgeletSeed ||
            t == FeatureType::kEdgeletSeedConverged);
}

inline bool isCorner(const FeatureType& t) {
    return (t == FeatureType::kCorner || t == FeatureType::kCornerSeed ||
            t == FeatureType::kCornerSeedConverged);
}

inline bool isMapPoint(const FeatureType& t) {
    return (t == FeatureType::kMapPoint || t == FeatureType::kMapPointSeed ||
...
inline bool isUnconvergedSeed(const FeatureType& t) {
    return (t == FeatureType::kCornerSeed || t == FeatureType::kMapPointSeed ||
