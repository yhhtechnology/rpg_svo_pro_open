...
/// Check the following references for more information about the IMU
/// parameters:
/// * https://github.com/ethz-asl/kalibr/wiki/IMU-Noise-Model-and-Intrinsics
/// * http://www-users.cs.umn.edu/~trawny/Publications/Quaternions_3D.pdf (Sec.
/// 2.1)
 ...
 public:
    ...
    inline void print(const std::string& s = "IMU Calibration: ") const {
        std::cout << s << std::endl
                  ...
                  << "  sigma_integration_c = " << imu_integration_sigma
                  << std::endl
...
struct ImuMeasurement {
    ...
    ImuMeasurement() {}
    ImuMeasurement(const double timestamp,
